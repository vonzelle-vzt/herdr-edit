...
| **A layout that degrades instead of refusing** | Below 50×24 upstream replaces everything with "Window too small — please resize". Since the tree is a fixed 30 columns, a side panel was only usable in a narrow band. The tree now auto-hides below 76 columns and the floors drop to 24×8. |
