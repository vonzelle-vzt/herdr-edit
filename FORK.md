...
| **Word wrap** | Upstream has none: long lines run off to the right and you scroll horizontally. `Esc z` reflows them to the pane instead, breaking on words, and re-reflows on every resize. Off by default, per tab. |
